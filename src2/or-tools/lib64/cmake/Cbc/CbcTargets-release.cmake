...
set_target_properties(Coin::Cbc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libCbc.so.2.10.12"
  IMPORTED_SONAME_RELEASE "libCbc.so.2"
  )

list(APPEND _cmake_import_check_targets Coin::Cbc )
list(APPEND _cmake_import_check_files_for_Coin::Cbc "${_IMPORT_PREFIX}/lib64/libCbc.so.2.10.12" )
...
set_target_properties(Coin::OsiCbc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libOsiCbc.so.2.10.12"
  IMPORTED_SONAME_RELEASE "libOsiCbc.so.2"
  )

list(APPEND _cmake_import_check_targets Coin::OsiCbc )
list(APPEND _cmake_import_check_files_for_Coin::OsiCbc "${_IMPORT_PREFIX}/lib64/libOsiCbc.so.2.10.12" )
...
set_target_properties(Coin::CbcSolver PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libCbcSolver.so.2.10.12"
  IMPORTED_SONAME_RELEASE "libCbcSolver.so.2"
  )

list(APPEND _cmake_import_check_targets Coin::CbcSolver )
list(APPEND _cmake_import_check_files_for_Coin::CbcSolver "${_IMPORT_PREFIX}/lib64/libCbcSolver.so.2.10.12" )
