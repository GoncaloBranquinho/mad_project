...
set_target_properties(ortools::ortools PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libortools.so.9.15.6755"
  IMPORTED_SONAME_RELEASE "libortools.so.9"
  )

list(APPEND _cmake_import_check_targets ortools::ortools )
list(APPEND _cmake_import_check_files_for_ortools::ortools "${_IMPORT_PREFIX}/lib64/libortools.so.9.15.6755" )
...
set_target_properties(ortools::flatzinc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libortools_flatzinc.so.9.15.6755"
  IMPORTED_SONAME_RELEASE "libortools_flatzinc.so.9"
  )

list(APPEND _cmake_import_check_targets ortools::flatzinc )
list(APPEND _cmake_import_check_files_for_ortools::flatzinc "${_IMPORT_PREFIX}/lib64/libortools_flatzinc.so.9.15.6755" )
