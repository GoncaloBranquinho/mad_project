...
set_target_properties(Coin::Clp PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libClp.so.1.17.10"
  IMPORTED_SONAME_RELEASE "libClp.so.1"
  )

list(APPEND _cmake_import_check_targets Coin::Clp )
list(APPEND _cmake_import_check_files_for_Coin::Clp "${_IMPORT_PREFIX}/lib64/libClp.so.1.17.10" )
...
set_target_properties(Coin::OsiClp PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libOsiClp.so.1.17.10"
  IMPORTED_SONAME_RELEASE "libOsiClp.so.1"
  )

list(APPEND _cmake_import_check_targets Coin::OsiClp )
list(APPEND _cmake_import_check_files_for_Coin::OsiClp "${_IMPORT_PREFIX}/lib64/libOsiClp.so.1.17.10" )
...
set_target_properties(Coin::ClpSolver PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libClpSolver.so.1.17.10"
  IMPORTED_SONAME_RELEASE "libClpSolver.so.1"
  )

list(APPEND _cmake_import_check_targets Coin::ClpSolver )
list(APPEND _cmake_import_check_files_for_Coin::ClpSolver "${_IMPORT_PREFIX}/lib64/libClpSolver.so.1.17.10" )
